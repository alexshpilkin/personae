...
in {
	...
	home.packages = with pkgs; [
		...
		azure-cli bench binutils-unwrapped.info binutils-unwrapped.man blobfuse breezy cvs cvsps fossil gcc-unwrapped.info gcc-unwrapped.man git-absorb git-annex git-annex-utils git-extras hyperfine loc mercurial perf-tools radare2 tig # development
